...
public class GroupsYouHaveCreatedActivity extends AppCompatActivity implements GroupAdapterClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_groups_you_have_created);
        ...
        list.add(object2);
        linearLayoutManager=new LinearLayoutManager(GroupsYouHaveCreatedActivity.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter=new GroupAdapter();
        adapter.setContext(list, Glide.with(GroupsYouHaveCreatedActivity.this),this);
    ...
    private void getReqs(Date date,boolean isRefresh){
        if(GenelUtil.isAlive(this)){
            ...
            ParseCloud.callFunctionInBackground("getGroupsIHaveCreated", params, (FunctionCallback<List<Group>>) (objects, e) -> {
                Log.e("done","done");
                if(GenelUtil.isAlive(GroupsYouHaveCreatedActivity.this)){
                    if(e==null){
    ...
    public void onClick(int position) {
        startActivity(
                new Intent(
                        GroupsYouHaveCreatedActivity.this
                        ,GroupActivity.class)
