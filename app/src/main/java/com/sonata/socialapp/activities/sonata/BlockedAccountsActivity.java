...
public class BlockedAccountsActivity extends AppCompatActivity implements BlockedAdapterClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(object2);
        linearLayoutManager=new LinearLayoutManager(BlockedAccountsActivity.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter=new BlockedPersonAdapter();
        adapter.setContext(list, Glide.with(BlockedAccountsActivity.this),this);
