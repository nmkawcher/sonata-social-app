...
public class PendingFollowRequestsActivity extends AppCompatActivity implements BlockedAdapterClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_follow_requests);
        ...
        list.add(object2);
        linearLayoutManager=new LinearLayoutManager(PendingFollowRequestsActivity.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter=new BlockedPersonAdapter();
        adapter.setContext(list, Glide.with(PendingFollowRequestsActivity.this),this);
    ...
    private void getReqs(Date date,boolean isRefresh){
        if(!this.isDestroyed()&&!this.isFinishing()){
            ...
            ParseCloud.callFunctionInBackground("getPendingFollowRequests", params, new FunctionCallback<List<SonataUser>>() {
                @Override
                public void done(List<SonataUser>  objects, ParseException e) {
                    Log.e("done","done");
                    if(!PendingFollowRequestsActivity.this.isFinishing()&&!PendingFollowRequestsActivity.this.isDestroyed()){
                        if(e==null){
    ...
    public void goToProfileClick(int position) {
        ...
        if(GenelUtil.clickable(700)){
            if(!user.getObjectId().equals(ParseUser.getCurrentUser().getObjectId())){
                startActivity(new Intent(PendingFollowRequestsActivity.this, GuestProfileActivity.class).putExtra("user",user));
            }
        }
    }
                        ...
                        ParseCloud.callFunctionInBackground("sendFollowRequest", params, new FunctionCallback<Object>() {
                            ...
                            public void done(Object object, ParseException e) {
                                ...
                                if(e==null){
                                    ...
                                    GenelUtil.ToastLong(PendingFollowRequestsActivity.this,getString(R.string.error));
                                }
