...
public class FollowingsActivity extends AppCompatActivity implements BlockedAdapterClick {
    ...
    private void getReqs(Date date,boolean isRefresh){
        if(Util.isAlive(this)){
            ...
            ParseCloud.callFunctionInBackground("getFollowings", params, new FunctionCallback<HashMap>() {
                @Override
                public void done(HashMap  objects, ParseException e) {
                    Log.e("done","done");
                    if(Util.isAlive(FollowingsActivity.this)){
                        if(e==null){
                            ...
                            if(objects!= null){
                                ...
                                initList((List<SonataUser>)objects.get("followings")
                        ...
                        ParseCloud.callFunctionInBackground("sendFollowRequest", params, new FunctionCallback<Object>() {
                            ...
                            public void done(Object object, ParseException e) {
                                ...
                                if(e==null){
                                    ...
                                    Util.ToastLong(FollowingsActivity.this,getString(R.string.error));
                                }
