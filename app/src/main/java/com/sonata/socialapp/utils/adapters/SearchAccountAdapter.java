...
public class SearchAccountAdapter extends RecyclerView.Adapter<SearchAccountAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SearchAccountAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if(i==TYPE_USER){
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.search_account_layout,viewGroup,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchAccountAdapter.ViewHolder holder, int position) {
