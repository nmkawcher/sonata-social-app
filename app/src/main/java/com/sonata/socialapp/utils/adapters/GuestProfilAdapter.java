...
public class GuestProfilAdapter extends RecyclerView.Adapter<GuestProfilAdapter.ViewHolder> {
    ...
    private static final int POST_TYPE_PRIVATE = 55;
    ...
    @NonNull
    @Override
    public GuestProfilAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if(i==POST_TYPE_TEXT){
    ...
    @Override
    public void onBindViewHolder(@NonNull GuestProfilAdapter.ViewHolder holder, int positiona) {
        if(getItemViewType(holder.getAdapterPosition())!=POST_TYPE_PRIVATE&&getItemViewType(holder.getAdapterPosition())!=POST_TYPE_TOP&&getItemViewType(holder.getAdapterPosition())!=POST_TYPE_LOAD&&getItemViewType(holder.getAdapterPosition())!=POST_TYPE_AD&&getItemViewType(holder.getAdapterPosition())!=POST_TYPE_EMPTY){
