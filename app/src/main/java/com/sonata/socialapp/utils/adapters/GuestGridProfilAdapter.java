...
public class GuestGridProfilAdapter extends RecyclerView.Adapter<GuestGridProfilAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public GuestGridProfilAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GuestGridProfilAdapter.ViewHolder holder, int positiona) {
